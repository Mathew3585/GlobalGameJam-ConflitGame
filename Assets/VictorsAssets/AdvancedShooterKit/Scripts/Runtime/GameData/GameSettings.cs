...
namespace AdvancedShooterKit
{
    public class GameSettings : ScriptableObject
    {
        ...
        static GameSettings rawInstance;
        private static GameSettings m_Instance
        {
            get
            {
                if( rawInstance == null )
                    rawInstance = Resources.Load<GameSettings>( typeof( GameSettings ).Name );
