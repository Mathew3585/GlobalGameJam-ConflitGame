...
namespace AdvancedShooterKit
{
    ...
    // Using for "ASKInputManager.cs"
    public enum EAxisStateClamp : byte
    {
        NotClamped,
        OnlyPositive,
        OnlyNegative
    ...
    public class InputSettings : ScriptableObject
    {
        ...
        static InputSettings rawInstance;
        private static InputSettings m_Instance
        {
            get
            {
                if( rawInstance == null )
                    rawInstance = Resources.Load<InputSettings>( typeof( InputSettings ).Name );
