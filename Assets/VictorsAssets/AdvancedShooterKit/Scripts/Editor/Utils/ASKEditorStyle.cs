...
{
    public class ASKEditorStyle
    {
        static ASKEditorStyle m_Instance;
        public static ASKEditorStyle Get { get { if( m_Instance == null ) m_Instance = new ASKEditorStyle(); return m_Instance; } }
